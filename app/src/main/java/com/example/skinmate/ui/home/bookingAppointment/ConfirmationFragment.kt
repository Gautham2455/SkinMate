...
class ConfirmationFragment:BaseFragment() {
    ...
    override fun onCreateView(
        ...
        ScheduleAppointmentFragment.appointmentSlots.removeAll(ScheduleAppointmentFragment.appointmentSlots)
        ScheduleAppointmentFragment.appointmentSlots.add("none")
